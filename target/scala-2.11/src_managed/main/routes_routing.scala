...
// @LINE:7
private[this] lazy val controllers_Application_users1_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users"))))
private[this] lazy val controllers_Application_users1_invoker = createInvoker(
controllers.Application.users,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Application", "users", Nil,"GET", """""", Routes.prefix + """users"""))
        

// @LINE:8
private[this] lazy val controllers_Application_user2_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("user"))))
private[this] lazy val controllers_Application_user2_invoker = createInvoker(
controllers.Application.user,
HandlerDef(this.getClass.getClassLoader, "", "controllers.Application", "user", Nil,"POST", """""", Routes.prefix + """user"""))
...
// @LINE:8
case controllers_Application_user2_route(params) => {
   call { 
        controllers_Application_user2_invoker.call(controllers.Application.user)
   }
}
